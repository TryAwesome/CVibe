    ...
    <TiltWrapper className="w-[480px] max-w-[90vw]">
      ...
      <CardContent className="grid gap-6">
        ...
        <div className="grid gap-2">
          ...
          <Input 
            id="password" 
            type="password" 
            className="bg-white/10 border-white/20 text-white focus:border-violet-400 focus:ring-violet-400 rounded-xl"
            required 
          />
        </div>
        <Button className="w-full bg-black hover:bg-slate-900 text-white rounded-xl py-6 shadow-lg transition-all hover:scale-[1.02]">
          Login
        </Button>
        ...
        <Button variant="outline" className="w-full border-white/20 bg-white/5 hover:bg-white/10 text-white rounded-xl py-6 shadow-sm transition-all hover:scale-[1.02]">
      ...
      <CardFooter>
        <div className="w-full text-center text-sm text-slate-300">
            ...
            <Link href="/register" className="font-bold text-white hover:underline underline-offset-4">
                Register
            </Link>
        </div>
      </CardFooter>
